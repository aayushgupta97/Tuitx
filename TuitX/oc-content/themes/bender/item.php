...
<div id="item-content">
    ...
    <div id="useful_info" class="bordered-box">
        ...
        <ul>
            <li><?php _e('Avoid Spamming the AD', 'bender'); ?></li>
            <li><?php _e('Multiple comments will be removed', 'bender'); ?></li>
            <li><?php _e('Don\'t make any payments online. Contact the tutor via e-mail', 'bender'); ?></li>
            <li><?php _e('This site is never involved in any transaction, and does not handle payments.', 'bender'); ?></li>
        </ul>
    </div>
